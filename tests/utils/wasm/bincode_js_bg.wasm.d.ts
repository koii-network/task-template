...
export function systeminstruction_createAccount(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function systeminstruction_assignWithSeed(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function systeminstruction_transfer(
  a: number,
  b: number,
  c: number,
): number;
...
export function systeminstruction_createNonceAccount(
  a: number,
  b: number,
  c: number,
  d: number,
): number;
export function systeminstruction_advanceNonceAccount(
  a: number,
  b: number,
): number;
export function systeminstruction_withdrawNonceAccount(
  a: number,
  b: number,
  c: number,
  d: number,
): number;
export function systeminstruction_authorizeNonceAccount(
  a: number,
  b: number,
  c: number,
): number;
...
export function pubkey_createWithSeed(
  a: number,
  b: number,
  c: number,
  d: number,
...
export function pubkey_createProgramAddress(
  a: number,
  b: number,
  c: number,
  d: number,
): void;
export function pubkey_findProgramAddress(
  a: number,
  b: number,
  c: number,
  d: number,
